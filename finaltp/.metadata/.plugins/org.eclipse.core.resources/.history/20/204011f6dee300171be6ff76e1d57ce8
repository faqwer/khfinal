function add_td() {
	...
	adate.setAttribute('id', 'schedule-' + (thd_th.length - 2));
	...
	document.body.removeChild(pagingscript);
	/*var schedulescript = document.getElementById("schedulescript");
	document.body.removeChild(schedulescript);*/
	var pagingscript = document.createElement('script');
	pagingscript.setAttribute('id', 'pagingscript');
	pagingscript.setAttribute('src', '/finaltp/js/tablePaging.js');	
	/*var schedulescript = document.createElement('script');
	schedulescript.setAttribute('id', 'schedulescript');
	schedulescript.setAttribute('src', '/finaltp/js/scheduleroute.js');
	document.body.appendChild(schedulescript);*/
	document.body.appendChild(pagingscript);
