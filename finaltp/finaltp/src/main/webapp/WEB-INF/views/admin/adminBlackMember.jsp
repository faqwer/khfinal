...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
	<br>
	<select name="sel" id="selBlackMember">
	...
	<input type="button" name="search" value="검색" id="idSearchBlackMember"
	...
	<table border="1" width=480 height=200 id="table">
		...
		<tbody align="center">
			<c:forEach var="dto" items="${memberList}">
				...
				<tr>
					<td><input type="checkbox" id="blackMemberCheck"
						value="${dto.id}"></td>
					<td>${dto.id}</td>
					<td>${dto.name}</td>
					<td>${dto.joindate}</td>
	...
	<div align="center" style="margin-top: 8px;">
		<input type="submit" id="blackNormalMove" value="일반">
		<input type="submit" id="blackMemberOut" value="탈퇴">
	</div>
